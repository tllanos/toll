...
/**
 * Clase encargada de Iniciar la simulación por medio de la integración de los
...
public class Simulator {
     ...
     * <p>
     * Para efectos semánticos de la simulación, se hace uso de hilos o
     * "Threads" (Los cuales representan los diferentes procesos que se ejecutan
     * simultaneamente para crear un entorno controlado que simula sucesos de la
     * vida real) lo cuales son almacenados en un objeto de tipo
    ...
    /**
     * Inicia la simulación al agrupar todos los métodos de la clase y hacerlos
     * trabajar conjuntamente. Adicionalmente, Mantiene un riguroso control
     * sobre todos los hilos o "Threads" y destruye los mismos cuando dejan de
     * ser requeridos.
     */
    ...
    private static class Worker implements Runnable {
        ...
        /**
         * Asigna los valores requeridos para iniciar el/los procesos en segundo
         * plano (Worker).
         *
         * @param connection
         * @param pstate
         ...
         * referente al campo "date", de la base de datos y calcula el flujo de
         * cada una basado en la cantidad de vehiculos que las cruzan por
         * minuto.
         */
        ...
        private synchronized void assignFlow() {
            try {
                ...
                for (Toll toll : tolls) {
                    ...
                    pstate = connection
                            .prepareStatement("SELECT COUNT(tollid) "
                                    + "FROM tollcash "
                                    + "WHERE date > date_sub(NOW(), "
                                    + "INTERVAL 1 MINUTE) " + "AND tollid = ?;");
                    pstate.setInt(1, id);
    ...
    /**
     * Recopila la información de todas las casetas ("tollbooths"), referente al
     * campo "date", de la base de datos y calcula el flujo de cada una basado
     * en la cantidad de vehiculos que las cruzan por minuto.
     */
