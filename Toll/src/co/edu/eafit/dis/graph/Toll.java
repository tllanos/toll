...
/**
 * Esta clase representa a un peaje en el sistema vial,
 * el cual estara encargado de "restringir" el movimiento del sistema,
 * y es aqui en los peajes donde se llavaran a cabo las transacciones,
 * y donde se calculara el flujo del sistema.
