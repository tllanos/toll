...
/**
 * Esta clase representa a un nodo en el grafo del sistema vial, y por tanto
 * podra ser o un peaje o una interseccion. Esta clase define los metodos
 * principales comunes a ambas.
 * 
...
public abstract class Node {
    ...
    /**
     * Constructor del nodo, comun a todos las instancias de quienes hereden al
     * nodo e inicializa las conexiones.
     * 
     * @param id
     *            es el valor numero que representa al nodo en la simulacion
     * @param source
     *            determina si el nodo es un punto de entrada al sistema
     */
     ...
     * 
     * @param node
     *            recibe es el identificador del destino y no el objeto.
     */
    ...
    /**
     * Retorna las conexiones a los demas nodos, es decir, todas las aristas,
